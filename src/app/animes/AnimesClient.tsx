...
export default function AnimesClient({ initialAnimes, initialTotal, availableGenres }: Props) {
  ...
  const load = useCallback(async () => {
    if (page === 1 && debouncedSearch === '' && selectedGenre === '' && selectedYear === '') {
    ...
    setTotal(total)
    setLoading(false)
  }, [page, debouncedSearch, selectedGenre, selectedYear, initialAnimes, initialTotal])
